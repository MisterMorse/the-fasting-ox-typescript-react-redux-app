    ...
    <div>
      ...
      <div className={ global.body }>
        <StaffMember
          name={ "Coy Howry" }
          role={ "Pastor" }
          imgSource={ "../../assets/images/staffCoy.jpg" }
        ...
        <StaffMember
          ...
          role={ "Music Minister" }
          imgSource={ "../../assets/images/staffBeverly.jpg" }
        ...
        <StaffMember
          ...
          imgSource={ "../../assets/images/staffAngie.jpg" }
        ...
        <StaffMember
          name={ "Tyler Ware" }
          role={ "Youth Minister" }
          imgSource={ "../../assets/images/staffTyler.jpg" }
